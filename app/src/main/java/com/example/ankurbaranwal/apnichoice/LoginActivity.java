...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chkBoxRememberMe =(com.rey.material.widget.CheckBox) findViewById(R.id.remeber_me_chkb);
        Paper.init(this);
    ...
    private void LoginUser() {
        ...
        {
            Toast.makeText(this,"Please write Your phone no...",Toast.LENGTH_LONG).show();
                    ...
                    if(usersData.getPhone().equals(phone))
                    {
                        if(usersData.getPassword().equals(password))
                        {
                            if(parentDbName.equals("Admins"))
                            {
                                ...
                                loadingBar.dismiss();
                                Intent intent = new Intent(LoginActivity.this,AdminCategaryActivity.class);
